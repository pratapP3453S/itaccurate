        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {courseDetail.keyFeatures.map((feature, index) => (
            ...
            >
              ...
              <div 
                className="absolute inset-0 bg-cover bg-center opacity-100 bg-opacity-40 group-hover:opacity-30 transition-opacity duration-500"
                style={{ backgroundImage: feature.bgImage }}
              ></div>
              
              {/* Card content with enhanced styling */}
              <div className="relative bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg border border-gray-200/50 dark:border-gray-700/50 rounded-2xl p-2 sm:p-4 lg:p-6 shadow-md hover:shadow-xl hover:shadow-purple-500/20 dark:hover:shadow-purple-400/10 transition-all duration-500 h-full flex flex-col items-center justify-center">
                <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 lg:gap-5 text-center">
                  <motion.div 
                    className="text-purple-600 dark:text-purple-400 text-2xl sm:text-3xl lg:text-4xl p-2 sm:p-3 bg-purple-100/50 dark:bg-purple-900/20 rounded-xl"
