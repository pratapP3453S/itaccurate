...
function Banner() {
    ...
    return (
        ...
        <div className="relative bg-white dark:bg-gray-900 transition-colors duration-300 pb-0">
            ...
            {/* Banner Section */}
            <section className="flex flex-col-reverse md:flex-row items-center px-4 sm:px-6 py-8 sm:py-12 md:py-20 sm:pt-28 pt-24 container mx-auto gap-4 sm:gap-7 md:h-[80vh] relative overflow-hidden">
                {/* Background Overlay */}
            ...
            <div className="absolute md:bottom-0 lg:left-0 pt-5 lg:top-[65vh] md:top-[80vh] md:right-0 left-1 z-20 md:px-24">
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 -mb-24 sm:-mb-20 md:-mb-24 lg:-mb-32">
